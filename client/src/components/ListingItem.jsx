    ...
    <div className="bg-white shadow-md hover:shadow-lg transition-shadow overflow-hidden rounded-lg w-full sm:w-[260px]">
      <Link to={`/listing/${listing._id}`}>
        <img
          ...
          alt="listing cover"
          className="h-[280px] sm:h-[180px] w-full object-cover hover:scale-105 transition-transform duration-300"
        />
        ...
        <div className="p-3 flex flex-col gap-2 w-full">
          ...
          <div className="text-slate-700 flex gap-4 mt-2">
            <div className="font-bold text-xs">🛏️{listing.bedRooms > 1 ? `${listing.bedRooms} beds` : `${listing.bedRooms} bed`}</div>
